package com.ls.contentcenter.config;
...
public class SwaggerConfig {
    ...
    public Docket createRestApi() {
        Docket docket = new Docket(DocumentationType.SWAGGER_2)
                ...
                .select()
                .apis(RequestHandlerSelectors.basePackage("com.ls.contentcenter.controller"))
